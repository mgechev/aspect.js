...
var before = function before(pattern) {};
...
var before = function before(classPattern, methodPattern) {
  _AspectCollection.AspectCollection.register(new _Aspect.Aspect({
...
var instance = new AspectCollection();

var applyAspects = function applyAspects(obj) {};
'use strict';
...
var applyAspects = function applyAspects(obj) {
  instance.aspects.forEach(function (a) {});
};
'use strict';
...
exports.AspectCollectio = AspectCollectio;
...
exports["default"] = new AspectCollectionClass();
module.exports = exports["default"];
'use strict';
...
exports['default'] = function (target) {
  'use strict';
  _AspectCollection2['default'].aspects.forEach(function (a) {
    if (a.methodPattern.test(target.name)) {
      meld[a.when](target.prototype, a.methodPattern, a.advice);
    }
  });
};
...
exports['default'] = function (target) {
  'use strict';
  _AspectCollection2['default'].aspects.forEach(function (a) {
    console.log(target.name, a.methodPattern);
    if (a.methodPattern.test(target.name)) {
      meld[a.when](target.prototype, a.methodPattern, a.advice);
    }
  });
...
exports['default'] = function (target) {
  ...
  _AspectCollection2['default'].aspects.forEach(function (a) {
    if (a.classPattern.test(target.name)) {
      console.log(target.prototype.getArticleById);
      _meld2['default'][a.when](target.prototype, a.methodPattern, a.advice);
    }
  });
};
...
exports['default'] = function (target) {
  ...
  _AspectCollection2['default'].aspects.forEach(function (a) {
    if (a.classPattern.test(target.name)) {
      _meld2['default'][a.when](target.prototype, a.methodPattern, a.advice);
      console.log(a.methodPattern.test('getArticleById'));
    }
  });
};
...
exports['default'] = function (target) {
  ...
  _AspectCollection2['default'].aspects.forEach(function (a) {
    if (a.classPattern.test(target.name)) {
      _meld2['default'][a.when](target.prototype, a.methodPattern, a.advice);
      console.log(_meld2['default'][a.when]);
    }
  });
};
...
exports['default'] = function (target) {
  ...
  _AspectCollection2['default'].aspects.forEach(function (a) {
    if (a.classPattern.test(target.name)) {
      _meld2['default'][a.when](target.prototype, a.methodPattern, a.advice);
      console.log(target.prototype.getArticleById.call({
        articles: []
      }));
    }
  });
